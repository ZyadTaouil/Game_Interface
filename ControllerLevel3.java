...
public class ControllerLevel3 {
	...
	@FXML
	private ImageView puzzle10;
	
	@FXML
	private ImageView puzzle11;
	
	@FXML
	private ImageView puzzle12;
	
	@FXML
	private ImageView puzzle13;
	
	@FXML
	private ImageView puzzle14;
	
	@FXML
	private ImageView puzzle15;
	
	@FXML
	private ImageView puzzle16;
	
	@FXML
	private ImageView puzzle17;
	
	@FXML
	private ImageView puzzle18;
	
	@FXML
	private ImageView puzzle19;
	
	@FXML
	private ImageView puzzle20;
	
	@FXML
	private ImageView puzzle21;
	
	@FXML
	private ImageView puzzle22;
	
	@FXML
	private ImageView puzzle23;
	
	@FXML
	private ImageView puzzle24;
	
	@FXML
	private ImageView puzzle25;
	...
	public void initializeMe() {
		...
		tab.add(puzzle10); tab.add(puzzle11); tab.add(puzzle12);
		tab.add(puzzle13); tab.add(puzzle14); tab.add(puzzle15);
		tab.add(puzzle16); tab.add(puzzle17); tab.add(puzzle18);
		tab.add(puzzle19); tab.add(puzzle20); tab.add(puzzle21);
		tab.add(puzzle22); tab.add(puzzle23); tab.add(puzzle24);
		tab.add(puzzle25);
		this.puzzle = tab;
	...
	public void isItAWin() {
		...
		for (int i = 1; i < puzzle.size(); i++) {
			...
			String name1 = index1[index1.length - 1];
			String name2 = index2[index2.length - 1];
			
			if (name1.length() == name2.length()) {
				if (name1.length() == 5 && name1.charAt(0) > name2.charAt(0)) flag = false;
				else if (name1.length() == 6) {
					if (name1.charAt(0) == name2.charAt(0)) if (name1.charAt(1) > name2.charAt(1)) flag = false;
					else if (name1.charAt(0) > name2.charAt(0)) flag = false;
				}
			} 
			else
				if (name1.length() > name2.length()) flag = false;
		}
		if (flag) {
